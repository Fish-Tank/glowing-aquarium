...
while True:
        ...
        if user_input == "exit":
            ...
            big = fish_data.sort_values('length', ascending=False)
            biggest = big.head(5)
            print(biggest)

        elif user_input == 'lakes':
            for i in range(len(further_commands)):
                print(further_commands[i])

        elif user_input == "bodensee":
            hoi = fish_data.loc[fish_data['lake'].str.contains('Boden')]
            ciao = hoi.head(2)
            print(ciao)
            print("hoi")

        elif user_input == "murtensee":
            hoi = fish_data.loc[fish_data['lake'].str.contains('Murten')]
            ciao = hoi.head(2)
            print(ciao)
            print("hoi")
        else:
